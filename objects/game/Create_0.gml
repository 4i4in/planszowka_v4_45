...
control_array = 
	{
		...
		draw_tile_extension : 1,	draw_terrain_markers : 1,	draw_tile_climate : 0, 
...
map_generator = 
	{
		map_x : 64, map_y : 64,	map_size_step : 32,	map_max_size : 128,  show_scale : 4,
		...
		*/
		...
		//humidity_references_magnitude_multipler :	[0.5,0.5,0.5,1.,1.,1.],
		...
		climate_descritpor : ["frozen","cold","temperate","warm","hot"],
		water_sum : 0,
